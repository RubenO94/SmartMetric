    ...
    <div class="flex flex-col">
        ...
        <div class="block w-full overflow-x-auto">
            <table class="w-full bg-transparent border-collapse table-auto">
                <thead>
                    <tr class="align-middle text-xs whitespace-nowrap font-bold text-left bg-gray-300 text-black">
                    ...
                    <tr class="border-b border-gray-300">
                        <td>
                            <div class="flex flex-row p-4 gap-x-2">
                                ...
                                <div class="flex flex-col">
                                    <p>Title</p>
                                    <p class="text-xs text-gray-400 overflow-hidden max-h-8 leading-4">description</p>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="bg-green-500 flex justify-center w-3/4 rounded-lg text-white">
                                Active
                            </div>
                        </td>
                        <td>07-12-2023</td>
