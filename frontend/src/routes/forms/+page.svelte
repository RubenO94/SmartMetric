...
<div class="mx-auto flex flex-col w-[1200px] p-10 gap-y-10">
    ...
    <div class="flex flex-col gap-y-2">
        ...
        <div class="flex items-center border-b border-gray-300 px-5 py-2 gap-x-5 rounded">
            <div class="bg-green-200 w-16 h-16 rounded-md flex items-center justify-center">AA</div>
            <div class="flex flex-col gap-x-1 py-2">
                <p>Title of FormTemplate</p>
                <p class="text-xs text-gray-400">This is a description for formTemplate</p>
            </div>
            <button class="bg-blue-500 text-white text-sm px-2 py-1 rounded-lg border border-transparent hover:bg-blue-700 hover:border-blue-950">Pré-visualizar</button>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
