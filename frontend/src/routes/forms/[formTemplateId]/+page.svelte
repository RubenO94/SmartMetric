...
<div class="mx-auto flex flex-col w-[1200px] p-10 gap-y-10">
    <div class="flex">
        ...
        <button class="ml-auto text-lg font-semibold px-10 py-2 border border-transparent bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-950 rounded">
            Edit form template
        </button>
    </div>
