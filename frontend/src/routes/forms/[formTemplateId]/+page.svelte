...
<div class="mx-auto flex flex-col w-[1200px] p-10 gap-y-10">
    <div class="flex">
        ...
        <a href="/forms/{formTemplate.formTemplateId}/edit" class="ml-auto flex gap-x-2 items-center font-semibold p-2 border border-transparent bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-950 rounded">
